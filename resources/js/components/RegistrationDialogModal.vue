                ...
                <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <div
                                    class="bg-white p-5 sm:p-8 relative"
                                    :class="
                                ...
                                >
                                    <!-- close button -->
                                    <div
                                        class="w-9 h-9 bg-slate-100 rounded-[32px] absolute top-4 flex justify-center items-center cursor-pointer"
                                        :class="
                                            master.langDirection === 'rtl'
                                                ? 'left-4'
                                                : 'right-4'
                                    ...
                                    <div
                                        class="text-slate-950 text-lg sm:text-2xl font-medium leading-loose"
                                    >
                                        {{ $t("Welcome") }}!
                                    </div>

                                    <div
                                        class="text-slate-950 text-lg font-normal leading-7 tracking-tight mt-3"
                                    >
                                    ...
                                    >
                                                ...
                                                <span
                                                    ...
                                                    :class="
                                                        ...
                                                        'rtl'
                                                            ...
                                                            : 'border-l rounded-tl-lg rounded-bl-lg'
                                                    "
                                                >
                                                    +{{
                                                        registerFormData.phone_code ||
                                                        "00"
                                                    }}
                                                </span>
                                                <input
                                                    ...
                                                    "
                                                    :minlength="
                                                        master.phoneMinLength
                                                    "
                                                    :maxlength="
                                                        master.phoneMaxLength
                                                    "
                                                    @input="
                                                        registerFormData.phone =
                                                            registerFormData.phone.replace(
                                                                /[^\d]/g,
                                                                ''
                                                            )
                                                    "
                                        ...
                                        <div
                                            class="px-4 pt-1 mt-4 flex items-center justify-center gap-2"
                                        >
                                            <div
                                                class="text-slate-900 text-base font-normal"
                                            >
                                                {{
                                                    $t(
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div v-if="!isSendOtpProcess">
                                        ...
                                        >
                                            <div
                                                class="text-slate-900 text-base font-normal leading-normal"
                                            >
                                                {{ $t("Resend code in") }}
                                            </div>
...
watch(
    () => registerFormData.value.country,
    () => {
        var findCountry = props.countries.find(
            (country) => country.name == registerFormData.value.country
        );
